...
func TestCompletionBash(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion", "bash"}
	...
	if !strings.Contains(output, "bash completion") || !strings.Contains(output, "__start_shopline") {
...
func TestCompletionZsh(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion", "zsh"}
...
func TestCompletionFish(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion", "fish"}
	...
	if !strings.Contains(output, "complete -c shopline") {
		t.Errorf("completion fish output does not contain 'complete -c shopline' marker")
	}
}
...
func TestCompletionPowerShell(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion", "powershell"}
...
func TestCompletionInvalidShell(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion", "invalid"}
...
func TestCompletionNoArgs(t *testing.T) {
	...
	os.Args = []string{"shopline", "completion"}
