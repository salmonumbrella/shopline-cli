...
var settingsDomainsUpdateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if dryRun {
			_, _ = fmt.Fprintln(formatterWriter, "[DRY-RUN] Would update settings domains")
			return nil
		}
...
var settingsLayoutsDraftUpdateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dryRun, _ := cmd.Flags().GetBool("dry-run")
		if dryRun {
			_, _ = fmt.Fprintln(formatterWriter, "[DRY-RUN] Would update settings layouts draft")
			return nil
		}
...
var settingsLayoutsPublishCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dryRun, _ := cmd.Flags().GetBool("dry-run")
		if dryRun {
			_, _ = fmt.Fprintln(formatterWriter, "[DRY-RUN] Would publish settings layouts")
			return nil
		}
...
var settingsThemeDraftUpdateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dryRun, _ := cmd.Flags().GetBool("dry-run")
		if dryRun {
			_, _ = fmt.Fprintln(formatterWriter, "[DRY-RUN] Would update settings theme draft")
			return nil
		}
...
var settingsThemePublishCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dryRun, _ := cmd.Flags().GetBool("dry-run")
		if dryRun {
			_, _ = fmt.Fprintln(formatterWriter, "[DRY-RUN] Would publish settings theme")
			return nil
		}
